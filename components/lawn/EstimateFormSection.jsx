    ...
    try {
      ...
      if (response.ok) {
        setNotification({
          isVisible: true,
          message:
            "Thank you! We will contact you soon with a personalized estimate.",
          type: "success",
        });
        setFormData({
          name: "",
      ...
      setNotification({
        isVisible: true,
        message:
          "Sorry, there was an error sending your estimate request. Please try again or call us directly.",
        type: "error",
      });
    } finally {
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="weekly-maintenance">
                      Weekly Maintenance
                    </option>
                ...
                <button
                  ...
                  className="w-full bg-red-500 text-white py-4 px-8 rounded-lg font-semibold text-lg transition-all duration-300 hover:bg-red-600 hover:scale-105 hover:shadow-xl transform active:scale-95 disabled:bg-red-300 disabled:transform-none disabled:hover:shadow-none"
                >
                  {isSubmitting
                    ? "Sending Request..."
            ...
            >
              <div className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <div className="space-y-4 text-gray-600 leading-relaxed">
                  <p>
                    At Mow & Shine, we understand that every lawn is unique,
                    with its own specific challenges and requirements. To offer
                    you an accurate quote and ensure exceptional results, our
                    experienced team conducts a thorough on-site assessment of
                    your property.
                  </p>
                  <p>
                    During our free consultation, we evaluate factors such as
                    lawn size, terrain, grass type, current condition, and any
                    special requirements you may have. Our experts also assess
                    drainage patterns, sun exposure, and existing landscaping to
                    create a customized care plan that will keep your lawn
